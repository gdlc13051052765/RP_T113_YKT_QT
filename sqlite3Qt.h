...
class Sqlite3QT
{
    public:
        ...
        int sqlite3_blaknumber_query_db(int number);
        ...
        int sqlite3_query_consume_recorn_db(void);
        int sqlite3_move_collection_record_to_collection_db();
        void Sqlite_update_ver(QString version);
};
