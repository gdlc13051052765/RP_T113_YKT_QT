...
struct qt_meta_stringdata_devMsg_t {
    QByteArrayData data[6];
    char stringdata0[61];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_devMsg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_devMsg_t qt_meta_stringdata_devMsg = {
    {
QT_MOC_LITERAL(0, 0, 6), // "devMsg"
QT_MOC_LITERAL(1, 7, 13), // "keyPressEvent"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 10), // "QKeyEvent*"
QT_MOC_LITERAL(4, 33, 2), // "ev"
QT_MOC_LITERAL(5, 36, 24) // "save_devMsg_to_config_db"

    },
    "devMsg\0keyPressEvent\0\0QKeyEvent*\0ev\0"
...
QT_INIT_METAOBJECT const QMetaObject devMsg::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_devMsg.data,
    qt_meta_data_devMsg,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *devMsg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_devMsg.stringdata0))
